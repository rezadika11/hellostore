                    ...
                    <div class="card-body">
                        <form action="{{ route('produk.update', $data->id_produk) }}" method="POST"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="name"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Nama Produk" value="{{ old('name', $data->name) }}">
                                    @error('name')
                                    ...
                                    @enderror"
                                        ...
                                        @foreach ($kategori as $item)
                                            <option value="{{ $item->id_kategori }}"
                                                {{ old('kategori', $data->id_kategori) == $item->id_kategori ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{ route('produk.getImage', $data->gambar) }}" width="150"
                                        class="img-fluid" height="100" alt="" id="imgPreview">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <textarea
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="deskripsi" cols="15" rows="8">{{ old('deskripsi', $data->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="berat"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Berat" value="{{ old('berat', $data->berat) }}">
                                    @error('berat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="harga"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Harga" value="{{ old('harga', $data->harga) }}">
                                    @error('harga')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="diskon"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Diskon" value="{{ old('diskon', $data->diskon) }}">
                                    @error('diskon')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="stok"
                                        ...
                                        is-invalid
                                    @enderror"
                                        placeholder="Stok" value="{{ old('stok', $data->stok) }}">
                                    @error('stok')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
